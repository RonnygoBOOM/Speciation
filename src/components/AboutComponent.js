...
class About extends Component {
    ...
    render() {
        return (
            <div>
                <h3 className="varela">Speciation is an NFT game loosely based on the concept of evolution. It starts with a single minted NFT: The Dream Pool. From there, at a set interval of time, 1 week, an NFT will spawn in the same wallet. 
